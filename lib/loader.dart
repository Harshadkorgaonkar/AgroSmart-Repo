...
class _LoaderPageState extends State<LoaderPage> {
  ...
  List<Map<String, dynamic>> loaders = [];
  bool isLoading = true;
  String errorMessage = '';
  ...
  Future<void> fetchLoaders() async {
    setState(() {
      isLoading = true;
      errorMessage = '';
    });
    ...
    try {
      final response = await supabase
          ...
          .eq('e_type', 'Front Loader')
          .eq('e_hide', false);

      loaders = (response as List<dynamic>).map<Map<String, dynamic>>((item) {
  ...
  List<Map<String, dynamic>> get filteredLoaders {
    return loaders.where((item) {
