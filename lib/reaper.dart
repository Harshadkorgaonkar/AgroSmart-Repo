...
class ReaperPage extends StatefulWidget {
  const ReaperPage({super.key});

  @override
  State<ReaperPage> createState() => _ReaperPageState();
}

class _ReaperPageState extends State<ReaperPage> {
  final supabase = Supabase.instance.client;

  List<Map<String, dynamic>> reapers = [];
  bool isLoading = true;
  String errorMessage = '';
  ...
  Future<void> fetchReapers() async {
    setState(() {
      isLoading = true;
      errorMessage = '';
    });
    ...
    try {
      ...
      reapers = (response as List<dynamic>).map<Map<String, dynamic>>((item) {
  ...
  List<Map<String, dynamic>> get filteredReapers {
    return reapers.where((item) {
