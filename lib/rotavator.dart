...
class RotavatorPage extends StatefulWidget {
  const RotavatorPage({super.key});

  @override
  State<RotavatorPage> createState() => _RotavatorPageState();
}

class _RotavatorPageState extends State<RotavatorPage> {
  final supabase = Supabase.instance.client;

  List<Map<String, dynamic>> rotavators = [];
  bool isLoading = true;
  String errorMessage = '';
  ...
  Future<void> fetchRotavators() async {
    setState(() {
      isLoading = true;
      errorMessage = '';
    });
    ...
    try {
      ...
      rotavators = (response as List<dynamic>).map<Map<String, dynamic>>((
        item,
      ) {
  ...
  List<Map<String, dynamic>> get filteredRotavators {
    return rotavators.where((item) {
