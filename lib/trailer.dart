  ...
  Future<void> fetchTrailers() async {
    ...
    try {
      final response = await supabase
          ...
          .eq('e_hide', false)
          .eq('e_type', 'Farm Trailer'); // ✅ सिर्फ Farm Trailer लाना है

      trailers = (response as List<dynamic>).map<Map<String, dynamic>>((item) {
